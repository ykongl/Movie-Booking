				...
				<div class="nav_list">
					...
					<div class="account_desc">
		                ...
		                <c:when test="${user == null}">
							...
							<a href="register.html" class="sign-in">  注册</a>
		                </c:when>
		                <c:otherwise>
		                	<a href="#" class="sign-in"><i class="fa fa-user"></i>${user.username } </a>
		                    <a href="logout.do" class="sign-in">  退出</a>
		                </c:otherwise>
                     </c:choose>
							<li><a href="preview.jsp">Delivery</a></li>
   	 ...
   	 <div class="wrap">
   	 	...
   	 	<div class="section group">
				...
				<div class="share-desc">
					<div class="share">	
					    <p>Username:</p><input class="text_box" type="text" name="username" placeholder="">	
					    <p>FilmName:</p><input class="text_box" type="text" name="filmName" placeholder=""><br>
						<p>Number:</p><input class="text_box" type="text" name="number" placeholder="">		
						<p>Price:</p><input class="text_box" type="text" name="price" placeholder="">		
					</div>
					<br>
